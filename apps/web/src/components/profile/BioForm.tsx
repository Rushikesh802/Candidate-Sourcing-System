    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5 pb-6 border-b border-slate-200">
        <div className="relative group">
          <div className="h-24 w-24 rounded-full overflow-hidden bg-slate-100 border-2 border-slate-200 flex items-center justify-center text-slate-400 shadow-sm">
            {photoUrl ? (
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            {photoUrl && (
              <button
                ...
                disabled={isUploadingPhoto}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg text-red-600 hover:bg-red-50 transition"
              >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className={`w-full px-3.5 py-2 text-sm rounded-lg border ${
              errors.first_name ? 'border-red-400 ring-1 ring-red-400' : 'border-slate-300'
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-3.5 py-2 text-sm rounded-lg border ${
              errors.last_name ? 'border-red-400 ring-1 ring-red-400' : 'border-slate-300'
            } focus:outline-none focus:ring-2 focus:ring-blue-500`}
            placeholder="Doe"
          />
        ...
        <div>
          ...
          />
          <p className="text-[11px] text-slate-400 mt-0.5">Email cannot be changed.</p>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className={`w-full px-3.5 py-2 text-sm rounded-lg border ${
                errors.mobile ? 'border-red-400 ring-1 ring-red-400' : 'border-slate-300'
              } focus:outline-none focus:ring-2 focus:ring-blue-500`}
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-3.5 py-2 text-sm rounded-lg border ${
              errors.date_of_birth ? 'border-red-400 ring-1 ring-red-400' : 'border-slate-300'
        ...
        <div className="sm:col-span-2">
          ...
          <textarea
            ...
            className="w-full px-3.5 py-2 text-sm rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
