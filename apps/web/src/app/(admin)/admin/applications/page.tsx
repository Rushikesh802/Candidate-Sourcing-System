        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div>
            <select
              ...
              className="w-full py-2 px-3 text-xs rounded-lg border border-slate-300 bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
      ...
      <div className="bg-white rounded-xl border border-slate-200/80 shadow-sm overflow-hidden">
        {isLoading ? (
          <div className="py-20 flex flex-col items-center justify-center text-slate-400">
            ...
            <p className="text-xs font-semibold">Loading applications pipeline...</p>
          </div>
            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="bg-slate-50/80 border-b border-slate-200 text-[11px] font-bold text-slate-500 uppercase tracking-wider">
                  ...
                  <th className="py-3.5 px-4">Position Applied For</th>
