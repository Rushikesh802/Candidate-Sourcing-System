    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              ...
              >
                ...
                <span className="text-slate-400 font-mono">({application.requisition.requisition_code})</span>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-semibold text-slate-700 bg-white border border-slate-300 hover:bg-slate-50 transition shadow-xs"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-semibold text-blue-700 bg-blue-50 border border-blue-200 hover:bg-blue-100 transition shadow-xs"
          >
            ...
            <div>
              ...
              <div className="flex items-center gap-4 text-xs text-slate-600 mt-1 flex-wrap">
                <span className="flex items-center gap-1">
                  ...
                  <a href={`mailto:${application.candidate_email}`} className="hover:text-blue-600">
                ...
                {application.candidate_mobile && (
                  <span className="flex items-center gap-1">
                    ...
                    <a href={`tel:${application.candidate_mobile}`} className="hover:text-blue-600">
                      {application.candidate_mobile}
                    </a>
                  </span>
                )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          {application.cover_note && (
            <div className="bg-white rounded-xl border border-slate-200/80 p-5 shadow-sm space-y-2">
              ...
              <p className="text-xs text-slate-700 whitespace-pre-line leading-relaxed bg-slate-50 p-4 rounded-lg border border-slate-100 italic">
          ...
          <div className="bg-white rounded-xl border border-slate-200/80 p-5 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-xs">
              ...
              <div>
                <span className="text-slate-400 text-[11px] block">Notice Period</span>
              ...
              <div>
                <span className="text-slate-400 text-[11px] block">Candidate Type</span>
                <span className="font-semibold text-slate-800">
              ...
              <div>
                <span className="text-slate-400 text-[11px] block">Current Company</span>
                <span className="font-semibold text-slate-800">
            ...
            {profSnapshot.current_address && (
              <div className="pt-2 border-t border-slate-100 text-xs">
                ...
                <span className="text-slate-700">{profSnapshot.current_address}</span>
              </div>
            )}
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200/80 p-5 shadow-sm space-y-4">
            ...
            {educations.length === 0 ? (
              <p className="text-xs text-slate-400 italic">No education entries recorded.</p>
            ) : (
              <div className="space-y-3">
                {educations.map((edu: any, idx: number) => (
                  <div
                    key={idx}
                    className="p-3.5 rounded-lg bg-slate-50 border border-slate-100 text-xs flex items-start justify-between gap-3"
                  >
                    <div>
          ...
          <div className="bg-white rounded-xl border border-slate-200/80 p-5 shadow-sm space-y-4">
            ...
            {profSnapshot.is_fresher ? (
              <div className="p-4 rounded-lg bg-blue-50/60 border border-blue-100 text-xs text-blue-800">
              ...
              <div className="space-y-4">
                {experiences.map((exp: any, idx: number) => (
                  <div
                    key={idx}
                    className="p-4 rounded-lg bg-slate-50 border border-slate-100 text-xs space-y-2"
                  >
                    ...
                    {exp.responsibilities && (
                      <p className="text-slate-600 text-[11px] leading-relaxed pt-1 border-t border-slate-200/50">
                        {exp.responsibilities}
                      </p>
                    )}
                  </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          {/* Resume Preview Card */}
          <div className="bg-white rounded-xl border border-slate-200/80 shadow-sm overflow-hidden flex flex-col h-[650px]">
          ...
          <div className="bg-white rounded-xl border border-slate-200/80 p-5 shadow-sm space-y-3">
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500 flex items-center gap-1.5 border-b border-slate-100 pb-2.5">
              <Briefcase className="h-4 w-4 text-blue-600" />
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="grid grid-cols-2 gap-2 pt-2 text-[11px] text-slate-600">
                <div>
                  ...
                  <span className="font-semibold">{application.requisition.department}</span>
                </div>
                <div>
                  <span className="text-slate-400 block">Location</span>
                  <span className="font-semibold">{application.requisition.location}</span>
                </div>
                <div>
                ...
                <div>
                  <span className="text-slate-400 block">Requisition Status</span>
                  <span className="font-semibold capitalize">
            ...
            <div className="pt-3 border-t border-slate-100">
              <Link
                href={`/admin/requisitions/${application.requisition_id}/applications`}
                className="w-full inline-flex items-center justify-center gap-1 px-3 py-2 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-xs transition"
              >
